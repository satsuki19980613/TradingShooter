export const PowerPlantSkin = () => {
  return (ctx, w, h) => {
    ...
    ctx.beginPath();
    ctx.arc(lightOffset, lightOffset, lightSize, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(w - lightOffset, lightOffset, lightSize, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(lightOffset, h - lightOffset, lightSize, 0, Math.PI * 2);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(w - lightOffset, h - lightOffset, lightSize, 0, Math.PI * 2);
    ctx.fill();
